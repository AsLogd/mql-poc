...
var grammar = {
    ...
    {"name": "start", "symbols": ["_", "start$ebnf$1"], "postprocess": identity},
    ...
    {"name": "body", "symbols": [(lexer.has("eq") ? {type: "eq"} : eq), "_", "expression"], "postprocess": removeTwo},
    ...
    {"name": "term", "symbols": ["sentence"], "postprocess": identity},
    {"name": "term", "symbols": ["function_call"], "postprocess": identity},
