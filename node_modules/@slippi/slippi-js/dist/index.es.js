import _, { get, forEach } from 'lodash';
import fs from 'fs';
...
function handleInputCompute(frames, state, indices, frame) {
    ...
    const prevPlayerFrame = _.get(frames, [
        playerFrame.frame - 1,
        "players",
        indices.playerIndex,
        "pre",
