...
var grammar = {
    ...
    {"name": "query", "symbols": ["verb_call", "target", "where", "query_content"], "postprocess": query},
    ...
    {"name": "expression", "symbols": ["not", "term", "_"], "postprocess": prefix},
    ...
    {"name": "not", "symbols": [(lexer.has("not") ? {type: "not"} : not), "__"], "postprocess": removeFirst},
