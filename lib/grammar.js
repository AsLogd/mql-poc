...
var grammar = {
    ...
    {"name": "statement", "symbols": ["import", "_"], "postprocess": takeFirst},
    ...
    {"name": "import", "symbols": [(lexer.has("import") ? {type: "import"} : "import"), "__", (lexer.has("string_val") ? {type: "string_val"} : string_val)], "postprocess": importExpr},
    ...
    {"name": "if_result", "symbols": ["__", (lexer.has("arrow") ? {type: "arrow"} : arrow), "_", (lexer.has("literal") ? {type: "literal"} : literal), "_"], "postprocess": ifResult(false)},
    {"name": "if_result", "symbols": ["__", (lexer.has("sparrow") ? {type: "sparrow"} : sparrow), "_", (lexer.has("literal") ? {type: "literal"} : literal), "_"], "postprocess": ifResult(true)},
    ...
    {"name": "term", "symbols": ["boolean"], "postprocess": takeFirst},
    ...
    {"name": "boolean", "symbols": [(lexer.has("true") ? {type: "true"} : true)], "postprocess": boolean},
    {"name": "boolean", "symbols": [(lexer.has("false") ? {type: "false"} : false)], "postprocess": boolean},
